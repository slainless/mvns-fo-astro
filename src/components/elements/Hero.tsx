      ...
      >
        <div class="font-heading flex flex-col items-center">
          ...
          >
            ...
            <span>the World.</span>
            <span class="text-red-600 text-5xl">Now You.</span>
          </h1>
        ...
        <nav class="font-body mt-4 gap-3 flex flex-col text-sm">
          <a
            id="register-link"
            class="dark:bg-white bg-zinc-800 text-red-600 font-poppins uppercase tracking-widest py-2 rounded-md inline-block font-medium"
          >
            Register Now
          </a>
